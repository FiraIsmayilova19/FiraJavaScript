...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let stores = {
      modaDunyasi: "Moda Dünyası",
      zerifModa: "Zərif Moda",
      eliyevModa: "Əliyev Moda Mərkəzi",
    };
    ...
    document.getElementById("modaDunyasi").addEventListener("click", () => {
      filterByStore(stores.modaDunyasi);
    });
    document.getElementById("zerifModa").addEventListener("click", () => {
      filterByStore(stores.zerifModa);
    });
    document.getElementById("eliyevModa").addEventListener("click", () => {
      filterByStore(stores.eliyevModa);
    });
  });
